...
function autoplay_Autoplay(_ref) {
  let {
    swiper,
    extendParams,
    on,
...
function plugins() {
    ...
    window.Navigation = navigation_Navigation
    window.Autoplay = autoplay_Autoplay
}
...
;// CONCATENATED MODULE: ./src/js/components/validation-phone-input.js
...
;// CONCATENATED MODULE: ./src/js/components/btn.js
function btn() {
  ...
  (async function loading() {
    ...
    async function mediaLoaded(e) {
      ...
      if (loadedMedia === totalMedia) {
        ...
        swiper_core_Swiper.use([Navigation, Pagination, Autoplay, EffectCoverflow]);
        btn();
        header();
        popups();
